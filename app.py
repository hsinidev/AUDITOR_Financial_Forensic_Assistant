...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.title("AUDITOR - Financial Forensic Assistant")
        ...
        self.selected_model = ctk.StringVar(value="gemma3:27b")
        ...
        self.render_formula(r"\text{Z-Score} = 1.2 X_1 + 1.4 X_2 + 3.3 X_3 + 0.6 X_4 + 0.99 X_5")
    ...
    def create_sidebar(self):
        ...
        self.model_menu = ctk.CTkOptionMenu(self.sidebar, values=["gemma3:27b", "llama3:70b"], variable=self.selected_model, fg_color=self.ACCENT_COLOR, button_hover_color=self.ACCENT_HOVER)
